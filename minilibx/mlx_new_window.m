...
- (NSWindowEvent *) initWithContentRect:(NSRect)rect styleMask:(NSUInteger)winstyle backing:(NSBackingStoreType)bck defer:(int) dfr
{
  int i;
  ...
  if ((self = [super initWithFrame:rect pixelFormat:pixFmt]) != nil)
    {
      ...
      //      int r = [win makeFirstResponder:nil];
